...
public class JWTUtil {
	...
	@Value("${jwt.secret}")  // parâmetro que está em application.properties
	...
	public boolean tokenValido(String token) {
		...
		if (claims != null) {
			...
			if (username != null && expirationDate != null && now.before(expirationDate)) {  //testa se já expirou
				return true;
			}
		}
		return false;
	...
	private Claims getClaims(String token) {
		try {
			...
			return null;
			// caso seja um token inválido ou deu algum problema
		}
	}
}
