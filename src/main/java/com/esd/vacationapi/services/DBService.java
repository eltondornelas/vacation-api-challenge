...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Funcionario func6 = new Funcionario(null, "Thiago Albertins", sdf.parse("09/07/1998"), sdf.parse("04/12/2014"), end4, eq1, "thiago.albertins@gmail.com",  pe.encode("321"));
		Funcionario func7 = new Funcionario(null, "Deyvson da Silva", sdf.parse("08/05/1986"), sdf.parse("29/09/2008"), end10, eq2, "deyvson@gmail.com", pe.encode("111"));
		Funcionario func8 = new Funcionario(null, "Luana Vilela", sdf.parse("07/11/1984"), sdf.parse("06/01/2011"), end9, eq3, "luana@gmail.com",  pe.encode("222"));
		Funcionario func9 = new Funcionario(null, "Paulo Alcantara", sdf.parse("16/08/1985"), sdf.parse("14/04/2017"), end5, eq2, "paulo@gmail.com", pe.encode("333"));
		Funcionario func10 = new Funcionario(null, "Sergio Lins", sdf.parse("16/01/1981"), sdf.parse("17/10/2018"), end6, eq2, "sergio@gmail.com", pe.encode("444"));
		...
		funcionarioRepository.saveAll(Arrays.asList(func1, func2, func3, func4, func5, func6, func7, func8, func9, func10));
